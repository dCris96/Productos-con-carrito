        ...
        <h4 className={styles.heading}>Your Cart ({totalCartItemsCount})</h4>
        {
            !totalCartItemsCount ? (
                <div className={styles.emptyCartContainer}>
                    <img src="./assets/images/illustration-empty-cart.svg" alt="empty cart" loading='lazy' />
                ...
                <div>
                    ...
                    <button className={styles.confirmButton} onClick={() => setIsModalOpen(true)}>Confirm Order</button>
                </div>
            )
        }
    </div>
